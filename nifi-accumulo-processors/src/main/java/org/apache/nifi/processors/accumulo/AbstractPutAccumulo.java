...
public abstract class AbstractPutAccumulo extends AbstractProcessor {
    ...
    protected static final PropertyDescriptor ROW_ID = new PropertyDescriptor.Builder()
            ...
            .required(true) // not all sub-classes will require this
            .expressionLanguageSupported(true)
            .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
            .build();
    ...
    protected static final PropertyDescriptor COLUMN_QUALIFIER = new PropertyDescriptor.Builder()
            ...
            .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
            .build();
    protected static final PropertyDescriptor COLUMN_VISIBILITY = new PropertyDescriptor.Builder()
            .name("Column Visibility")
            .description("The Column Visibility to use when inserting data into Accumulo")
            .required(true)
            .expressionLanguageSupported(true)
            .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
            .build();
    ...
    public void onScheduled(final ProcessContext context) {
        clientService = context.getProperty(ACCUMULO_CLIENT_SERVICE).asControllerService(AccumuloClientService.class);
    }
    ...
    protected String getTransitUri(PutFlowFile putFlowFile) {
        return "accumulo://" + putFlowFile.getTableName() + "/" + new String(putFlowFile.getRow());
    }
